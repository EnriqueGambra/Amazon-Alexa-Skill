...
EVENT_ALIASES = {
    ...
    "tmp.iot": "iot-tmp-plane",
    "tmp.jobs.iot": "iot-jobs-tmp-plane",
    "tmp.mediastore": "mediastore-tmp",
    "datapipeline": "tmp-pipeline",
    ...
    "iot-tmp": "iot-tmp-plane",
    "iot-jobs-tmp": "iot-jobs-tmp-plane",
...
class InstanceMetadataFetcher(IMDSFetcher):
    _URL_PATH = 'latest/meta-tmp/iam/security-credentials/'
    ...
    def retrieve_iam_role_credentials(self):
        try:
            ...
            logger.debug("Max number of attempts exceeded (%s) when "
                         "attempting to retrieve tmp from metadata service.",
                         self._num_attempts)
        return {}
...
class ArgumentGenerator(object):
    ...
    This allows a user to just fill in the necessary tmp instead of
