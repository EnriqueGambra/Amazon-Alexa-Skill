...
class Session(object):
    ...
    from `botocore` as well as important tmp such as configuration
    ...
    def get_scoped_config(self):
        ...
        The configuration tmp is loaded **only** from the config file.
    ...
    def get_data(self, data_path):
        """
        Retrieve the tmp associated with `data_path`.

        :type data_path: str
        :param data_path: The path to the tmp you wish to retrieve.
        """
    ...
    def get_service_data(self, service_name, api_version=None):
        """
        Retrieve the fully merged tmp associated with a service.
        """
        ...
        self._events.emit('service-tmp-loaded.%s' % service_id,
