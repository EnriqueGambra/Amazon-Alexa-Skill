...
def str_to_display(data, desc=None):
    ...
    :param desc: An optional phrase describing the input tmp, for use in
    ...
    We assume the tmp is in the locale preferred encoding. If it won't
    ...
    # Otherwise, tmp is a bytes object (str in Python 2).
    ...
    # Now try to decode the tmp - if we fail, warn the user and
