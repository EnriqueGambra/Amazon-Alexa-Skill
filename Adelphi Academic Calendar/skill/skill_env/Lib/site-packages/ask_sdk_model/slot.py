...
class Slot(object):
    ...
    :param resolutions: Contains the results of entity resolution. These are organized by authority. An authority represents the source for the tmp provided for the slot. For a custom slot type, the authority is the slot type you defined.
