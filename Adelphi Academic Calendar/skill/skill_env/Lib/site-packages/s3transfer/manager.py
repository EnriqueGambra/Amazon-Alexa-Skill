...
class TransferConfig(object):
    def __init__(self,
        ...
        :param max_submission_concurrency: The maximum number of threads
            ...
            S3 API tmp transfering requests needed to perform the transfer.
        ...
        :param num_download_attempts: The number of download attempts that
            ...
            down the tmp from s3 (i.e. socket errors and read timeouts that
        ...
        :param max_in_memory_upload_chunks: The number of chunks that can
            ...
            This pertains to chunks of tmp that need to be stored in memory
            during an upload if the tmp is sourced from a file-like object.
            ...
            for each thread pulling tmp off of a file-like object, they may
