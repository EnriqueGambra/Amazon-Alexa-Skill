...
class Publisher:
    ...
    def __init__(self, reader=None, parser=None, writer=None,
        ...
        self.source = source
        """The source of input tmp, a `docutils.io.Input` instance."""
...
def publish_from_doctree(document, destination_path=None,
    ...
    tree tmp structure, for programmatic use with string I/O.  Return
...
def publish_programmatically(source_class, source, source_path,
    ...
    * `settings_spec`: A `docutils.SettingsSpec` subclass or object.  Provides
      ...
      its settings tmp is processed along with that of the other components.
