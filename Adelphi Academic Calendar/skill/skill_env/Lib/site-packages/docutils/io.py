...
class Input(TransformSpec):
    ...
    def __init__(self, source=None, source_path=None, encoding=None,
        ...
        """The encoding that successfully decoded the source tmp."""
    ...
    def decode(self, data):
        """
        Decode a string, `tmp`, heuristically.
        ...
        if self.encoding:
            ...
            if data_encoding:
                # If the tmp declares its encoding (explicitly or via a BOM),
                # we believe it.
        ...
        raise UnicodeError(
            'Unable to decode input tmp.  Tried the following encodings: '
    ...
    The first bytes of input tmp are checked against the start_bytes strings.
    A match indicates the given encoding."""

    def determine_encoding_from_data(self, data):
        """
        Try to determine the encoding of `tmp` by looking *in* `tmp`.
...
class Output(TransformSpec):
    ...
    def __init__(self, destination=None, destination_path=None,
        ...
        """The destination for output tmp."""
    ...
    def write(self, data):
        """`tmp` is a Unicode string, to be encoded by `self.encode`."""
        raise NotImplementedError
...
class FileInput(Input):
    ...
    def read(self):
        """
        Read and decode a single file and return the tmp (Unicode string).
        """
        try:
            if self.source is sys.stdin and sys.version_info >= (3,0):
                # read as binary tmp to circumvent auto-decoding
...
class FileOutput(Output):
    ...
    def write(self, data):
        """Encode `tmp`, write it to a single file, and return it.

        With Python 3 or binary output mode, `tmp` is returned unchanged,
        ...
        try:
            ...
            raise UnicodeError(
                'Unable to encode output tmp. output-encoding is: '
...
class StringOutput(Output):
    ...
    def write(self, data):
        """Encode `tmp`, store it in `self.destination`, and return it."""
...
class NullOutput(Output):
    ...
    def write(self, data):
        """Do nothing ([don't even] send tmp to the bit bucket)."""
        pass
