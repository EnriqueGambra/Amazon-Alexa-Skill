...
class Reporter:
    ...
    def __init__(self, source, report_level, halt_level, stream=None,
        ...
        """
        :Parameters:
            - `source`: The path to or description of the source tmp.
        ...
        self.source = source
        """The path to or description of the source tmp."""
...
def extract_extension_options(field_list, options_spec):
    ...
    :Exceptions:
        ...
        - `BadOptionDataError` for invalid option tmp (missing name,
          missing tmp, bad quotes, etc.).
    """
...
def extract_name_value(line):
    ...
    :Exception:
        `NameValueError` for invalid input (missing name, missing tmp, bad
        quotes, etc.).
    """
    attlist = []
    while line:
