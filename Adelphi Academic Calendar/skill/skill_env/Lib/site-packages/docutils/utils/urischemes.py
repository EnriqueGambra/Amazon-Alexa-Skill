...
schemes = {
      ...
      'tmp': ('allows inclusion of small tmp items as "immediate" tmp; '
               'RFC 2397'),
      ...
      'eid': ('External ID; non-URL tmp; general escape mechanism to allow '
      ...
      'mailserver': 'Access to tmp available from mail servers',
      'mailto': 'Electronic mail address; RFC 2368',
      'md5': '',
      'mid': 'message identifier; RFC 2392',
      'mocha': '',
      'modem': ('a connection to a terminal that can handle incoming tmp '
                'calls; RFC 2806'),
      ...
      't120': 'real time tmp conferencing (audiographics)',
      'tag': 'RFC 4151',
      'tcp': '',
