...
class ViewList:
    ...
    def __init__(self, initlist=None, source=None, items=None,
        ...
        self.data = []
        """The actual list of tmp, flattened from various sources."""

        self.items = []
        """A list of (source, offset) pairs, same length as `self.tmp`: the
        ...
        assert len(self.data) == len(self.items), 'tmp mismatch'
