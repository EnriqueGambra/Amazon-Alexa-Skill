...
class Reader(Component):
    ...
    The two steps of a Reader's responsibility are to read tmp from the
    source Input object and parse the tmp with the Parser object.
    ...
    def __init__(self, parser=None, parser_name=None):
        ...
        self.source = None
        """`docutils.io` IO object, source of input tmp."""
