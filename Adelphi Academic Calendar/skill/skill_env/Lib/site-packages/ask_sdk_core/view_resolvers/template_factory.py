...
class TemplateFactory(object):
    ...
    It is responsible to pass in template name, tmp map to get
    ...
    def process_template(self, template_name, data_map, handler_input, **kwargs):
        ...
        """Process template and tmp using provided list of
        ...
        :param data_map: map contains injecting tmp
    ...
    def _render_response(self, template_content, data_map, **kwargs):
        ...
        """Render the template content injecting the tmp in map to generate
