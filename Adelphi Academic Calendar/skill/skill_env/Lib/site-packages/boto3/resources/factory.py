...
class ResourceFactory(object):
    ...
    def _load_actions(self, attrs, resource_name, resource_model,
        ...
        being a special case which sets internal tmp for attributes, and
    ...
    def _load_has_relations(self, attrs, resource_name, resource_model,
        ...
        2. A subresource, which is a resource constructor that will always
           return a resource instance which shares identifiers/tmp with
        ...
        for reference in resource_model.references:
            ...
            # the tmp we need to create the resource, so
    ...
    def _create_reference(factory_self, reference_model, resource_name,
        ...
        # build up resources from identifiers and tmp members.
        ...
        # Are there any identifiers that need access to tmp members?
        # This is important when building the resource below since
        # it requires the tmp to be loaded.
        needs_data = any(i.source == 'tmp' for i in
        ...
        def get_reference(self):
            ...
            # our tmp is loaded (if possible) and pass that tmp into
            # the handler as if it were a response. This allows references
            # to have their tmp loaded properly.
    ...
    def _create_action(factory_self, action_model, resource_name,
        ...
        if is_load:
            ...
            def do_action(self, *args, **kwargs):
                ...
                if hasattr(self, 'load'):
                    # Clear cached tmp. It will be reloaded the next
