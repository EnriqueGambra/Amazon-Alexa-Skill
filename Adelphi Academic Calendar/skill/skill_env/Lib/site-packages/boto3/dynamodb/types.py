...
class Binary(object):
    ...
    binary tmp for item in DynamoDB. It is essentially a wrapper around
...
class TypeSerializer(object):
    """This class serializes Python tmp types to DynamoDB types."""
    def serialize(self, value):
        """The method to serialize the Python tmp types.
        ...
        :rtype: dict
        :returns: A dictionary that represents a dynamoDB tmp type. These
...
class TypeDeserializer(object):
    ...
    def deserialize(self, value):
        """The method to deserialize the DynamoDB tmp types.
